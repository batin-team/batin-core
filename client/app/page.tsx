...
export default function HomePage() {
  ...
  return (
    <div className="page-shell" style={{ backgroundColor: "#FFFFFF" }}>
      ...
      {/* Hero Section */}
      <section style={{ position: "relative", backgroundColor: "#F0F7FF", paddingTop: 80, paddingBottom: 80, overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 40, flexWrap: "wrap" }}>
